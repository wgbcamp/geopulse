    ...
    return (
        <div className={`flex fixed top-0 z-3 w-full flex-wrap 2xl:flex-nowrap ${dataOptions || menuOptions ? '' : 'overflow-hidden h-14.75'} lg:h-[unset]`}>
            ...
            <div className='h-14.75 flex flex-wrap lg:flex-nowrap lg:w-40'>
                <Card className={`rounded-none p-0 flex flex-col items-center justify-center gap-0 hover:bg-white transition-colors duration-200 ${location.pathname == "/eventtracking" || location.pathname == "/" ? 'bg-white' : 'bg-(--accentblue-30)'} border-0`}>
            ...
            <div className='h-14.75 flex grow lg:grow-0 lg:w-70'>
                <Card className={`shadow-none rounded-none grow p-0 h-full flex flex-col items-center justify-end gap-0 hover:bg-white transition-colors duration-200 ${location.pathname == "/compare" || location.pathname == "/grid" ? 'bg-white' : 'bg-(--accentblue-30)'} border-0`}>
                    ...
                    <div className="flex flex-end flex-col w-full ">
                        <div className="flex flex-row justify-evenly items-start w-full h-full">
                            <Link to="/compare" activeOptions={{ exact: true }} className='flex flex-col justify-end w-full cursor-pointer' onClick={() => { actions?.setView("Compare"); }}>
                            ...
                            <Link to="/grid" activeOptions={{ exact: true }} className='flex flex-col justify-end w-full cursor-pointer' onClick={() => { actions?.setView("Grid"); }}>
                                <div className="flex flex-row h-8.75 items-center justify-center">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='bg-white h-full w-10 lg:w-0 lg:hidden flex justify-center items-center cursor-pointer' style={location.pathname == "/eventtracking" ? { backgroundColor: "bg-(--accentblue-30)" } : { backgroundColor: "white" }}>
