...
export const Header = () => {
    ...
    const calendarComponent =
        <Card className={`rounded-none w-full h-22 lg:h-14.75 lg:w-40 p-0 px-2 items-center justify-center shadow-none border-x-0 gap-0`}>
            <div className='w-full flex flex-col items-center'>
                <Popover open={calendarOpened} onOpenChange={() => setCalendarOpened(!calendarOpened)}>
                    <PopoverTrigger asChild>
                        <div className="flex flex-row items-center w-95/100 h-full lg:h-14.75 justify-between cursor-pointer">
                            <div className="flex w-full lg:w-62 justify-between items-center pl-2">
    ...
    return (
        <div className={`grid grid-cols-[1fr] lg:grid-cols-[232px_1fr_1fr] lg:h-14.75 fixed w-full top-0 z-3 ${dataOptions || menuOptions ? '' : 'overflow-hidden h-14.75'} lg:h-[unset]`}>
            ...
            <div className='w-full lg:h-14.75 grid grid-cols-[1fr_1fr_50px] lg:grid-cols-[1fr_1fr]'>
                <div className=' flex'>
                ...
                <div className='h-14.75 flex'>
                    <Card className={`shadow-none rounded-none lg:grow p-0 w-full h-full flex flex-col items-center justify-end gap-0 hover:bg-white transition-colors duration-200 ${location.pathname == "/compare" || location.pathname == "/grid" ? 'bg-white' : 'bg-(--accentblue-30)'} border-0`}>
                        ...
                        <div className="flex flex-end flex-col w-full">
                            <div className="flex flex-row justify-evenly items-start h-full">
                                <Link to="/compare" activeOptions={{ exact: true }} className='flex flex-col justify-end cursor-pointer' onClick={() => { actions?.setView("Compare"); }}>
                                ...
                                <Link to="/grid" activeOptions={{ exact: true }} className='flex flex-col justify-end cursor-pointer' onClick={() => { actions?.setView("Grid"); }}>
                                    <div className="flex flex-row h-8.75 items-center justify-center">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='bg-(--accentblue-30) w-full h-full flex justify-center items-center cursor-pointer lg:h-0 lg:w-0 lg:hidden'>
            ...
            {location.pathname == "/eventtracking" ?
                <div className={`flex flex-col lg:flex-row ${dataOptions ? 'h-full' : 'h-0'} w-full`}>
                    <Card className="rounded-none p-0 flex flex-col items-center justify-center gap-0 h-22 lg:h-14.75 w-full lg:w-45 px-2">
                    ...
                    {calendarComponent}
                    <Card className="rounded-none p-0 flex flex-col items-center justify-center gap-0 h-22 lg:h-14.75 w-full lg:w-38 px-2">
            ...
            {(location.pathname === "/compare" || location.pathname === "/grid") ?
                <div className={`flex flex-col  lg:flex-row w-full lg:w-auto ${dataOptions ? 'h-full' : 'h-0'} lg:h-14.75 overflow-hidden`}>
                    <Card id="hazardExposure" className="rounded-none border-0 p-0 flex flex-col h-22 lg:w-58 px-2 items-center justify-center gap-0 ">
                    ...
                    <Card id="scenario" className="border-0 rounded-none p-0 flex flex-col h-22 items-center justify-center gap-0 lg:w-35 px-2">
                        <div className='w-95/100 border-b-2'>
                    ...
                    <div className='w-full flex bg-white'>
                        <div id="timeline" className='h-22 w-full lg:w-80 flex justify-center items-center px-2'>
