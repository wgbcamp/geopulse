...
export const About = () => {
    return (
        <div className={`absolute flex justify-center w-full overflow-auto mix-blend-hard-light bg-(--accentdarkblue-70) transition-all bg-cover`} style={{ backgroundImage: `url(${MenuBackground})` }}>
